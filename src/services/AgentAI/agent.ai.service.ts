            ...
            messages: [
                {
                    ...
                    You must detect whether a post is a **Signal**, a **PreSignal (Protosignal)**, or **Irrelevant**,  
                    and output ONLY valid JSON (no text outside JSON).
                    
                    📌 Definitions:
                    - Signal: A clear, unconditional trading idea or prediction.  
                      Example: "BTC will go up to $70k", "ETH short target $2,200".  
                      → Must always include "direction".  
                      → "condition" must be null.
                    
                    - PreSignal (Protosignal): A **conditional** prediction.  
                      Example: "If BTC breaks $50k, then it will rise to $55k".  
                      → Must always include "direction" and a "condition".  
                      → Condition is what differentiates it from a Signal.
                    ...
                    - direction: Always required for both Signal and PreSignal → "bullish" or "bearish".  
                    - condition:  
                      - Mandatory for PreSignal (the “if/when” part).  
                      - Always null for Signal and Irrelevant.  
                    ...
                    📌 Special rules:
                    - If both unconditional and conditional parts exist in the same post → classify as PreSignal (condition dominates).  
                    - Direction mappings:  
